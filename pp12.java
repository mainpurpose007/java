...
p1.add(Update);
Downloaded by Legend (deepakchauhan7721@gmail.com)
lOMoARcPSD|34381610
...
scroll.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDE
D);
...
con = DriverManager.getConnection("jdbc:postgresql:project2", "postgres",
"postgres");
...
conn = DriverManager.getConnection("jdbc:postgresql:project2", "postgres",
"postgres");
